          ...
          <div className="py-16 md:py-24 lg:py-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h2 className="text-2xl font-display font-semibold">Formulaire de Contact</h2>
                <form className="space-y-4">
                  <div>
                    <Label htmlFor="name" className="text-brand-text/80">Nom</Label>
                    <Input id="name" type="text" placeholder="Votre Nom" className="bg-white/80 border-brand-accent/30 focus:border-brand-accent focus:ring-brand-accent" />
                  </div>
                  <div>
                    <Label htmlFor="email" className="text-brand-text/80">Email</Label>
                    <Input id="email" type="email" placeholder="Votre Email" className="bg-white/80 border-brand-accent/30 focus:border-brand-accent focus:ring-brand-accent" />
                  </div>
                  <div>
                    <Label htmlFor="message" className="text-brand-text/80">Message</Label>
                    <Textarea id="message" placeholder="Votre Message" rows={5} className="bg-white/80 border-brand-accent/30 focus:border-brand-accent focus:ring-brand-accent" />
                  </div>
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-display font-semibold">Suivez-Moi</h2>
