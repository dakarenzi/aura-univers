          ...
          <div className="py-24 md:py-32 lg:py-40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                <div>
                  <h2 className="text-3xl font-display font-semibold text-brand-gold">Engagement & Passion</h2>
                  <p className="mt-4 text-base leading-relaxed text-foreground/90">
                ...
                <Separator className="bg-brand-gold/20" />
                <div>
                  <h2 className="text-3xl font-display font-semibold text-brand-gold">Réalisations</h2>
